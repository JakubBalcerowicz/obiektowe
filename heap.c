    ...
    while(chooseSortCheck==1){
        ...
        switch(chooseSort){
            ...
            case 2:
                ...
                break;
            case 3:
                strcat(sortType,"QuickSort");
                clock_gettime(CLOCK_PROCESS_CPUTIME_ID,&tp0);
                Quicksort(tabA,0,heapLength);
                clock_gettime(CLOCK_PROCESS_CPUTIME_ID,&tp1);
                chooseSortCheck=0;
                break;
            case 4:
...
void PrintInf(){
    system("cls");
                printf("\n Sortest, v.1.0, Dawid Lipinski\n");
                printf("...........................................................................................");
                printf("\nProgram SortTest pozwala:\n\n");
                printf("a)\tWygenerowanie tablicy o danej wielkosci i zapelnienie jej losowymi wartosciami \n");
                printf("\tlub podanymi z klawiatury. Umozliwia takze pobranie wartosci do tablicy z pliku \n");
                printf("\tinsert.txt, ktory jednoczesnie jest przechowywalnia zbioru liczb do ostatniego\n");
                printf("\twykonywanego sortowania.\n");
                printf("\nb)\tSortowac dana tablice liczb metoda sortowania przez wstawianie, sortowania \n  ");
                printf("\tkopcowego, sortowania szybkiego lub sortowania babelkowego.\n");
                printf("\nc)\tZapisywac wynik sortowania i dodatkowe dane (czas wykonania poszczegolnych czynnosci");
                printf("\n\t w unikalnym pliku txt generowanym automatycznie, zawierającym w nazwie typ sortowania");
                printf("\n\toraz ogolny numer wykonywanego sortowania lub nadanie\n ");
                printf("\tnazwy wlasnorecznie. Zapisywanie nie jest konieczne\n");
                printf("...........................................................................................");
                printf("\n\n\tProgram powstal jako rozwiniecie projektu majacego sortowac kopcowo\n");
                printf("\ttablice wypelniona wartosciami pobranymi z pliku insert.txt i zapisujaca wynik \n");
                printf("\tw pliku output.txt");
    }
